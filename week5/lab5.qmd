...
H0: There is no difference in the proportion of successes between the use of garden staples and popsicle sticks.

HA: Popsicle sticks have a greater rate of success for eel grass restoration in comparison to garden staples.
...
# WHY ARE WE USING DIFFERENCE IN PROPORTION FOR THE FIRST ARGUMENT? IN CLASS WE DISCUSSED USING EITHER 0.025 OR 0.975. 
# WHY DO WE SET THE MEAN EQUAL TO 0 AND NOT USE DIFFERENCE OF PORPOTION IN THIS POSITION? 
...
The p-value is greater than the critical threshold 0.05. We fail to reject the null hypothesis. There is not enough evidence to support that popsicle sticks are more successful than garden staples in the restoration of eel grass.
...
Difference in means between the success of popsicle sticks and garden staples.
...
The permutation and mathematical models are both trying to estimate the whether there is a difference in success between the treatments.

**Q12: What are bootstrapping and mathematical models [both]{.underline} trying to estimate for confidence intervals?**

The confidence interval models where we are confident that the value will fall 95% of the time.

**Q13: What area under the curve is relevant to hypothesis tests? What R function calculates it for a mathematical model?**

The p-value is relevant for hypothesis tests. This tells us with whether we can accept of reject the null hypothesis. pnorm() calculates the p-value.

**Q14: What area under the curve is relevant to confidence intervals? What R function calculates it for a mathematical model?**

The area between the confidence intervals is relevant as 95% of the values are within this area. qnorm() calculates this area.
